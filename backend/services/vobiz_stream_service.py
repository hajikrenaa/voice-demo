    ...
    def _build_prompt_ta(self) -> str:
        ...
        if not is_mini:
            ...
            parts.append(
                ...
                "'புரியுது/சரி'னு நடிக்காதீங்க — மறுபடி கேளுங்க.\n"
                ...
                "'@' = 'at the rate', '.' = 'dot'.\n"
                "5. அழைப்பவர் spell பண்ணா அந்த letters-ஐ அப்படியே திருப்பிச் "
                "சொல்லி 'சரிதானே?'னு கேளுங்க — எந்த letter-ஐயும் மாத்தாதீங்க.\n"
